Pod::Spec.new do |s|
  ...
  s.version        = '1.0.0'
  s.summary        = 'ExecuTorch client native module for Pulse-FL.'
  s.description    = 'Integrates ExecuTorch C++ runtime into Expo for Arrhythmia Detection.'
  s.homepage       = 'https://github.com/bernardbdas/pulse-fl'
  s.license        = { :type => 'MIT' }
  s.author         = '@bernardbdas'
  s.source         = { :git => 'https://github.com/bernardbdas/pulse-fl.git' }
  s.platform       = :ios, '13.4'
  s.swift_version  = '5.4'
